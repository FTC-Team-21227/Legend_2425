...
public class AUTON2025REDLEFT_5 extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder tab1 = drive.actionBuilder(initialPose)
                .lineToX(23);// hang specimen
        TrajectoryActionBuilder tab2 = drive.actionBuilder(new Pose2d(23, 72, 0))
                .lineToX(18); //back up
        TrajectoryActionBuilder tab3 = drive.actionBuilder(new Pose2d(18, 72, 0))
//                .strafeTo(new Vector2d(11, 55.5)) //back up to hang specimen, y+5 worked empirically
                .strafeTo(new Vector2d(8, 114.5)) //get 1st sample from the left side
                        .strafeTo(new Vector2d(10.5, 114.5)); //get 1st sample from the left side
        TrajectoryActionBuilder tab4 = drive.actionBuilder(new Pose2d(10.5, 114.5, Math.toRadians(0)))
                .strafeToLinearHeading(new Vector2d(5.5, 95), Math.toRadians(140)) //go away from wall bec arms lifting
                .strafeTo(new Vector2d(3.5, 123)); //go to basket
        TrajectoryActionBuilder tab5 = drive.actionBuilder(new Pose2d(3.5, 123, Math.toRadians(140)))
        ...
        TrajectoryActionBuilder tab6 = drive.actionBuilder(new Pose2d(13, 124.5, Math.toRadians(0)))
                ...
                .strafeToLinearHeading(new Vector2d(3.5, 123), Math.toRadians(140));//go to basket
        TrajectoryActionBuilder tab7 = drive.actionBuilder(new Pose2d(3.5,123, Math.toRadians(140)))
                .strafeTo(new Vector2d(12, 111))//go away from while lowering arms
                .splineToLinearHeading(new Pose2d(8.5, 133, Math.toRadians(0)), Math.toRadians(0)) //get 3rd sample
                .strafeTo(new Vector2d(10.5, 134.5)); //go forward to grab 3rd sample
        TrajectoryActionBuilder tab8 = drive.actionBuilder(new Pose2d(10.5,134.5, Math.toRadians(0)))
                .strafeTo(new Vector2d(51, 46))
                .strafeToLinearHeading(new Vector2d(5.5, 95), Math.toRadians(140)) //go away from wall bec arms lifting
                .strafeTo(new Vector2d(3.5, 123)); //go to basket
        TrajectoryActionBuilder tab9 = drive.actionBuilder(new Pose2d(3.5,123, Math.toRadians(140)))
