...
public class AUTON2025REDRIGHT_9 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //5 spec auto attempt, possibly slightly more optimized pushing.
        ...
        TrajectoryActionBuilder tab5 = drive.actionBuilder(new Pose2d(72, -50, Math.toRadians(-90))) //go to second specimen
                .splineToConstantHeading(new Vector2d(72,-40),Math.toRadians(90)) //CHANGED: made robot crash into wall for alignment.
                .splineToConstantHeading(new Vector2d(72,-44.5), Math.toRadians(90),new TranslationalVelConstraint(10));
        TrajectoryActionBuilder tab6 = drive.actionBuilder(new Pose2d(72, -44, Math.toRadians(-90))) //pick up and place second specimen
